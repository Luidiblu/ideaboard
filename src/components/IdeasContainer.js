...
class IdeasContainer extends Component {
  ...
  componentDidMount() {
    axios.get('https://salty-oasis-93452.herokuapp.com/api/v1/ideas.json')
    .then(response => {
  ...
  addNewIdea = () => {
    axios.post('https://salty-oasis-93452.herokuapp.com/api/v1/ideas', {idea: {title: '', body: ''}})
    .then(response => {
  ...
  deleteIdea = (id) => {
    axios.delete(`https://salty-oasis-93452.herokuapp.com/api/v1/ideas/${id}`)
    .then(response => {
